...
public class Cooldown<K> {
    ...
    /** @param durationMs durée du cooldown en millisecondes */
    ...
    /** {@code true} si {@code key} est encore en cooldown. */
    ...
    /** Temps restant en millisecondes (0 si pas en cooldown ou inconnu). */
